...
python -u external/mocov3/run_moco.py \
    --image_path /cluster/CBIO/data1/lgortana/test/tif/CytAssist_11mm_FFPE_Human_Ovarian_Carcinoma_tissue_image.tif \
    --save_path /cluster/CBIO/data1/lgortana/test \
    --tag test-rn50 \
    --json_path /cluster/CBIO/data1/lgortana/test/seg_json/pannuke_fast_mask_lvl3.json \
