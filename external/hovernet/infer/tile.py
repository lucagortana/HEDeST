    ...
    def process_file_list(self, run_args):
        ...
        def proc_callback(results):
            ...
            if self.save_qupath:
                ...
                convert_format.to_qupath(save_path, nuc_coms_list, nuc_type_list, self.type_info_dict)
        ...
        while len(file_path_list) > 0:
            ...
            dataset = SerializeFileList(cache_image_list, cache_patch_info_list, self.patch_input_shape)
