# -*- coding: utf-8 -*-
# Vision Transformer backbone for CellViT backend in PanoSpace.
#
# Adapted and clarified based on original CellViT implementation.
#
...
# -----------------------------------------------------------------------------
# Utility: Truncated Normal Initialization
# -----------------------------------------------------------------------------
