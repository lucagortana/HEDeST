...
from cellvit.config.config import COLOR_CODES_LOGGING
...
class Logger:
    ...
    def create_handler(self, logger: logging.Logger):
        ...
        if self.log_parent_dir is not None:
            ...
            log_handlers["FileHandler"] = logging.handlers.RotatingFileHandler(log_parent_dir / log_name, backupCount=5)
    ...
    def create_logger(self) -> logging.Logger:
        ...
        logger.setLevel("DEBUG")  # set to debug because each handler level must be equal or lower
