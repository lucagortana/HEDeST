...
if __name__ == "__main__":
    # argparse
    parser = argparse.ArgumentParser(description="Clean a CellViT classifier checkpoint by removing unnecessary keys.")
    parser.add_argument("input_path", type=str, help="Path to the input checkpoint")
    parser.add_argument("output_path", type=str, help="Path to save the cleaned checkpoint")
