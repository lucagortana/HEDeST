...
def cache_test_database(run_dir: str = os.path.abspath(os.getcwd()), logger: Optional[logging.Logger] = None) -> Path:
    ...
    if not database_dir.exists():
        ...
        with open(filelist_path, mode="w", newline="") as csvfile:
            ...
            writer.writerow(["./test_database/BRACS/BRACS_1640_N_3_cropped.tiff", "0.25", "40"])
