...
for seed in 42 43 44 45 46; do
  python3 -u hedest/main.py \
    ...
    /cluster/CBIO/data1/lgortana/Visium_FFPE_Human_Breast_Cancer/props/DestVI_2000_hvg_squash_055_02_no_endo_Visium_FFPE_Human_Breast_Cancer_prop.csv \
    ...
    --train-size 0.8 \
    --val-size 0.1 \
    --out-dir models/Breast_cancer_FFPE/DestVI_2000_hvg_squash_055_02_no_endo/model_quick_alpha_0.0_lr_0.0003_divergence_l2_beta_0.0_seed_${seed} \
