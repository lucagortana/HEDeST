...
python -u external/CellViT/cellvit/detect_cells.py \
    ...
    --gpu 0 \
    --batch_size 8 \
    --outdir /cluster/CBIO/data1/lgortana/Visium_FFPE_Human_Breast_Cancer/seg_json/ \
    --export_cells \
    --save_geojson \
    --size_px 64 \
    --size_um 20 \
    --image_dict_path /cluster/CBIO/data1/lgortana/Visium_FFPE_Human_Breast_Cancer/image_dict_64px_20um.pt \
    --adata_path /cluster/CBIO/data1/lgortana/Visium_FFPE_Human_Breast_Cancer/adata.h5ad \
    process_wsi \
