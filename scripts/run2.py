...
#            train_size=0.5, 
#            val_size=0.25, 
#            out_dir='../out/model_bs8_lr1e-5_agglossonehot_alpha02_epochs50') #change
...
run_plugin(adata, 
           ...
           train_size=0.5, 
           val_size=0.25, 
           out_dir='../out/model_bs8_lr1e-5_agglossmean_alpha02_epochs50') #change
...
#            train_size=0.5, 
#            val_size=0.25, 
#            out_dir='../out/model_bs8_lr1e-3_agglossonehot_alpha02_epochs50') #change
...
#            train_size=0.5, 
#            val_size=0.25, 
#            out_dir='../out/model_bs8_lr1e-3_agglossmean_alpha02_epochs50') #change