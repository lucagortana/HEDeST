from module.run_model import run_plugin
from tools.hovernet_tools import map_cells_to_spots, extract_tiles_hovernet
import pandas as pd
import scanpy as sc
import torch
import click
...
def main(adata_name, 
    ...
    if image_dict_path is not None and os.path.exists(image_dict_path):
        ...
        image_dict = extract_tiles_hovernet(image_path, 
                                            json_path, 
                                            level=level, 
                                            size=size, 
