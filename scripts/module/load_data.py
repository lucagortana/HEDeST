...
class SpotDataset(Dataset):
    def __init__(self, spot_dict, proportion_df, image_dict):
        ...
        Args:
            ...
            proportion_df (pd.DataFrame): DataFrame where each row corresponds to a spot and columns represent cell type proportions.
    ...
    def __getitem__(self, idx):
        ...
        images = torch.stack([self.image_dict[cell_id].float() / 255.0 for cell_id in cell_ids]) #change to float and normalize
