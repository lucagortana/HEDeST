...
python3 -u run.py \
    ...
    --train_size 0.5 \
    --val_size 0.25 \
    --out_dir ../out/model_lr1e-5_agglossmean_alpha05_epochs60_se32 \
    --rs 42 \
    --size_edge 32 \
    --save_images dict \
...
python3 -u run.py \
    ...
    --train_size 0.5 \
    --val_size 0.25 \
    --out_dir ../out/model_lr1e-5_agglossmean_alpha03_epochs60_se32 \
    --rs 42 \
    --size_edge 32 \
    --save_images dict \
...
python3 -u run.py \
    ...
    --train_size 0.5 \
    --val_size 0.25 \
    --out_dir ../out/model_lr1e-5_agglossmean_alpha01_epochs60_se32 \
    --rs 42 \
    --size_edge 32 \
    --save_images dict \
...
python3 -u run.py \
    ...
    --train_size 0.5 \
    --val_size 0.25 \
    --out_dir ../out/model_lr1e-5_agglossonehot_alpha05_epochs60_se32 \
    --rs 42 \
    --size_edge 32 \
    --save_images dict \
...
python3 -u run.py \
    ...
    --train_size 0.5 \
    --val_size 0.25 \
    --out_dir ../out/model_lr1e-5_agglossonehot_alpha03_epochs60_se32 \
    --rs 42 \
    --size_edge 32 \
    --save_images dict \
...
python3 -u run.py \
    ...
    --train_size 0.5 \
    --val_size 0.25 \
    --out_dir ../out/model_lr1e-5_agglossonehot_alpha01_epochs60_se32 \
    --rs 42 \
    --size_edge 32 \
    --save_images both \
