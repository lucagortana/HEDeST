...
from .augs import add_to_brightness
from .augs import add_to_contrast
from .augs import add_to_hue
from .augs import add_to_saturation
from .augs import gaussian_blur
from .augs import median_blur
...
class FileLoader(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        target_dict = self.target_gen_func(inst_map, self.mask_shape, **self.target_gen_kwargs)
    ...
    def __get_augmentation(self, mode, rng):
        if mode == "train":
            shape_augs = [
                ...
                iaa.CropToFixedSize(self.input_shape[0], self.input_shape[1], position="center"),
