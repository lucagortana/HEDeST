...
def get_tile_patch_info(img_shape, tile_input_shape, patch_input_shape, patch_output_shape):
    ...
    tile_output_shape = round_to_multiple(tile_output_shape, patch_output_shape).astype(np.int64)
    tile_input_shape = (tile_output_shape + patch_diff_shape).astype(np.int64)

    patch_input_tl_list, _ = get_patch_top_left_info(img_shape, patch_input_shape, patch_output_shape)
    ...
    tile_input_tl_list, _ = get_patch_top_left_info(img_shape, tile_input_shape, tile_output_shape)
    ...
    tile_input_br_list[y_sel, 0] = (img_shape[0] - patch_diff_shape[0]) - tile_input_tl_list[y_sel, 0]
    tile_input_br_list[x_sel, 1] = (img_shape[1] - patch_diff_shape[1]) - tile_input_tl_list[x_sel, 1]
    tile_input_br_list[y_sel, 0] = round_to_multiple(tile_input_br_list[y_sel, 0], patch_output_shape[0])
    tile_input_br_list[x_sel, 1] = round_to_multiple(tile_input_br_list[x_sel, 1], patch_output_shape[1])
