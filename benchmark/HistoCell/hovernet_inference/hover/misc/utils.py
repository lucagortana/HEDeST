...
def type_colour(model_name):
    ...
    if model_name == "pannuke":
        colour_dict = {0: (0, 0, 0), 1: (255, 0, 0), 2: (0, 255, 0), 3: (0, 0, 255), 4: (255, 255, 0), 5: (255, 165, 0)}
    elif model_name == "monusac":
        colour_dict = {0: (0, 0, 0), 1: (255, 0, 0), 2: (0, 255, 0), 3: (0, 0, 255), 4: (255, 255, 0)}
