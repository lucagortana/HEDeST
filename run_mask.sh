...
python3 -u external/hovernet/run_mask.py \
        /cluster/CBIO/data1/lgortana/Visium_Human_Breast_Cancer/pyr_tif/Visium_Human_Breast_Cancer_image.tif \
        /cluster/CBIO/data1/lgortana/Visium_Human_Breast_Cancer/mask/lvl3/Visium_Human_Breast_Cancer_image.png \
        --mask-level 3 \
