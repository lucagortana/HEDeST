...
python3 -u hovernet/run_mask.py \
        /cluster/CBIO/data1/lgortana/Xenium_FFPE_Human_Breast_Cancer_Rep1/tif/Xenium_FFPE_Human_Breast_Cancer_Rep1_he_image.tif \
        /cluster/CBIO/data1/lgortana/Xenium_FFPE_Human_Breast_Cancer_Rep1/mask/Xenium_V1_humanLung_Cancer_FFPE_tissue_image.png \
        --mask-level 3 \
