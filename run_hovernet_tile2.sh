...
python external/hovernet/run_infer.py \
    ...
    tile \
    --input_dir=/cluster/CBIO/data1/lgortana/Xenium_V1_humanLung_Cancer_FFPE/histocell/LCA/tiles/LCA_256_hires \
    --output_dir=/cluster/CBIO/data1/lgortana/Xenium_V1_humanLung_Cancer_FFPE/histocell/LCA/seg/LCA_256_hires \
    --mem_usage=0.1 \
    --draw_dot \
    --save_qupath
